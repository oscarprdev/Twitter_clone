...
export const getUnfollowersUsecase = new DefaultGetUnfollowersUsecase(getUnfollowersHttpAdapter, reduxUsecase);

const addFollowHttpAdapter = new AddFollowHttpAdapter(followersInfra);
export const addFollowUsecase = new DefaultAddFollowUsecase(addFollowHttpAdapter, reduxUsecase);

const removeFollowHttpAdapter = new RemoveFollowHttpAdapter(followersInfra);
export const removeFollowUsecase = new DefaultRemoveFollowUsecase(removeFollowHttpAdapter, reduxUsecase);
